...
## 0. Avant d'entrer dans la salle (5 min, la veille)

```bash
docker compose --profile complet up -d --build
docker cp backend/uploads/. certiftogo_api:/app/uploads/   # sinon PDF et QR en 404
...
Attendus : `"ancre":true`, puis `200`, puis `200`.
