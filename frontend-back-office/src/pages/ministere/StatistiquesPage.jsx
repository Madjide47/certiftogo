// ─────────────────────────────────────────────────────────────
// Ministère — statistiques : répartition des dossiers transmis (tous
// établissements).
// ─────────────────────────────────────────────────────────────
...
export default function StatistiquesPage() {
  ...
  return (
    <div>
      <PageHeader titre="Statistiques" sous="Répartition des dossiers transmis au ministère." />
      ...
      {chargement ? (
        ...
        <div className="max-w-3xl space-y-6">
          <div className="grid grid-cols-2 gap-6 sm:grid-cols-3">
            <StatCard libelle="Total transmis" valeur={total} icone="inbox" />
